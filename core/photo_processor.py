...
class PhotoProcessor:
    ...
    def _prepare_detectors(
        self,
        keypoint_detector: Optional[KeypointDetector],
        flight_detector: Optional[FlightDetector],
        use_keypoints: bool,
        use_flight: bool,
    ):
        ...
        return keypoint_detector, flight_detector, use_keypoints, use_flight
    ...
    def process_single_image(
        ...
        keypoint_detector, flight_detector, use_keypoints, use_flight = self._prepare_detectors(
            keypoint_detector, flight_detector, use_keypoints, use_flight
        )
        ...
        ui_settings = self._build_ui_settings()
    ...
    def process_single_image_with_yolo_result(
        self,
        filename: str,
        filepath: str,
        raw_dict: Dict[str, str],
        yolo_result: Optional[Tuple[Any, ...]],
        keypoint_detector: Optional[KeypointDetector] = None,
        flight_detector: Optional[FlightDetector] = None,
        exiftool_mgr: Any = None,
        use_keypoints: bool = True,
        use_flight: bool = True,
        photo_start_time: Optional[float] = None,
    ) -> Dict[str, Any]:
        """
        Process a single image with a precomputed YOLO result.
        """
        ...
        # 解析 AI 结果
        detected, _, confidence, sharpness, _, bird_bbox, img_dims, bird_mask = yolo_result
