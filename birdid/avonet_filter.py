...
REGION_BOUNDS = {
    ...
    # 澳大利亚各州
    "AU-QLD": (-29, -10, 138, 154),            # 昆士兰
    "AU-NSW": (-37.5, -28, 141, 154),          # 新南威尔士
    "AU-VIC": (-39.2, -34, 141, 150),          # 维多利亚
    "AU-TAS": (-43.7, -39.5, 143.5, 148.5),    # 塔斯马尼亚
    "AU-SA": (-38, -26, 129, 141),             # 南澳大利亚
    "AU-WA": (-35, -13.5, 112.5, 129),         # 西澳大利亚
    "AU-NT": (-26, -10.5, 129, 138),           # 北领地
    "AU-ACT": (-35.95, -35.1, 148.75, 149.4),  # 首都领地
